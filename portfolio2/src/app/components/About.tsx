...
const TIMELINE = [
  ...
  },
  {
    ...
    description: "Completed flagship projects: Automatic Pet Feeder with Web Interface, Automatic Price Computer using Image Recognition, and Streamlit apps.",
    tags: ["Image Recognition", "Flask", "Streamlit", "IoT", "Machine Learning"],
    status: "current",
    icon: "💡",
  },
  {
    ...
    institution: "RTU — BS CpE",
    description: "Graduating with a Bachelor of Science in Computer Engineering, ready to contribute to the industry with a strong foundation in both hardware and software.",
    tags: ["Graduation", "Full Stack", "Embedded Systems"],
    status: "future",
    icon: "🏆",
  },
];
