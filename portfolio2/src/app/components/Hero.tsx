...
const LOGO_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Word", icon: "https://cdn.simpleicons.org/microsoftword/2B579A", bg: true },
    ],
  },
  {
    label: "LIBRARIES",
            ...
            >
              <div className="relative animate-float">
                ...
                <div className="relative w-56 h-56 sm:w-72 sm:h-72 rounded-full border-2 border-green-400/40 overflow-hidden green-glow-border">
                  <ImageWithFallback
                    src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=600"
